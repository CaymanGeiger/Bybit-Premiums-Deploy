...
const structuredData = {
  ...
  keywords:
    "Bybit Premiums, borrow rates, funding rates, margin trading, trade borrow rates Bybit",
  "og:title": "About Bybit Premiums - Trade Smarter",
  "og:description":
    "Discover Bybit Premiums for real-time borrow and funding rates to enhance your trading decisions.",
  "og:image": "/icon.png",
...
const AboutUsStructuredData = {
  ...
  description:
    "Leading platform for real-time borrow rates and funding rates for Bybit traders.",
